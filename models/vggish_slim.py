...
def create_vggish_slim(fingerprint_input, model_settings, dropout_prob=0.8, is_training=False):
    ...
    net = define_vggish_slim(fingerprint_4d, is_training)
    print(net.shape)
    with slim.arg_scope(
...
def define_vggish_slim(input, training=False):
